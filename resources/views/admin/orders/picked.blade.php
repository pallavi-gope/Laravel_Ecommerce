                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Picked</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Picked Orders List&nbsp;<span class="badge badge-pill bg-primary">{{ count($orders) }}</span></h3>
                    </div>
                    <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center"><span class="badge badge-pill bg-primary">{{ $item->status }}</span></th>
