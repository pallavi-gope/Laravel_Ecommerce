            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Delivered Orders List&nbsp;<span class="badge badge-pill bg-primary">{{ count($orders) }}</span></h3>
                    </div>
                    <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center"><span class="badge badge-pill bg-success">{{ $item->status }}</span></th>
