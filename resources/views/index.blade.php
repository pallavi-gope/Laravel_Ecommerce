                    ...
                    <div class="tab-pane" id="category{{ $category->id }}">
                        <div class="product-slider">
                            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                                @forelse($catwiseProd as $catprod)
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="#"><img src="{{ asset($catprod->product_thumbnail) }}" alt=""></a> </div>
                                                @if($product->discount_price == NULL)
                                                <div class="tag new"><span>New</span></div>
                                                @else
                                                @php
                                                $amount = $catprod->selling_price - $catprod->discount_price;
                                                $discount = ($amount/$catprod->selling_price)*100;
                                                @endphp
                                                <div class="tag sale"><span>{{ round($discount) }} %</span></div>
                                                @endif
                                            </div>
                                            <div class="product-info text-left">
                                                <h3 class="name"><a href="#">@if(session()->get('language') == 'hindi') {{ $catprod->product_name_hin }} @else {{ $catprod->product_name_en }} @endif</a></h3>
                                                <div class="rating rateit-small"></div>
                                                <div class="description"></div>
                                                @if($catprod->discount_price == NULL)
                                                <div class="product-price"> <span class="price">Rs. {{ $catprod->selling_price }}</span></div>
                                                @else
                                                <div class="product-price"> <span class="price">Rs. {{ $catprod->discount_price }}</span> <span class="price-before-discount">Rs. {{ $catprod->selling_price }}</span> </div>
                                                @endif
                                            </div>
                                            <div class="cart clearfix animate-effect">
                                                <div class="action">
