                            ...
                            <div class="product-item-holder size-big single-product-gallery small-gallery">
                                ...
                                <div class="single-product-gallery-thumbs gallery-thumbs">
                                    <div id="owl-single-product-thumbnails">
                                        ...
                                        <div class="item">
                                            <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide{{ $thumb->id }}">
                                                <img class="img-responsive" width="85" alt="" src="{{ asset($thumb->image) }}" data-echo="{{ asset($thumb->image) }}" />
                                            </a>
                                        </div>
                                        @endforeach
                                    </div>
                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                <h1 class="name" id="pname">
                                    @if(session()->get('language') == 'hindi') {{ $products->product_name_hin }} @else {{ $products->product_name_en }} @endif
                                </h1>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="stock-box">
                                                ...
                                                @else
                                                <span class="badge badge-pill bg-danger">Stock Out</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="description-container m-t-20">
                                    @if(session()->get('language') == 'hindi') {{ $products->short_desc_hin }} @else {{ $products->short_desc_en }} @endif
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                ...
                                                @else
                                                <span class="price">Rs.{{ $products->discount_price }}</span>
                                                <span class="price-strike">Rs.{{ $products->selling_price }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="color" id="color" class="form-control unicase-form-control">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="size" id="size" class="form-control unicase-form-control">
                            ...
                            <div class="tab-content">
                                <div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <div class="text">
                                            @if(session()->get('language') == 'hindi') {!! $products->long_desc_hin !!} @else {!! $products->long_desc_en !!} @endif
                                        </div>
                                    </div>
                                </div>
